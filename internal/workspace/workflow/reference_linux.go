...
func validateReference(ref PathReference) error {
	if ref.Version != 1 || !gitadapter.ValidID(ref.Name) || (ref.OCI != "none" && ref.OCI != "auto" && !core.ValidPersistentResourceRef(core.PersistentResourceRef{ID: ref.OCI, Owner: "0123456789abcdef0123456789abcdef"})) {
