...
func (*store) readFile(string) ([]byte, error) { return nil, fmt.Errorf("unsupported platform") }
func (*store) saveFile(string, []byte) error   { return fmt.Errorf("unsupported platform") }
