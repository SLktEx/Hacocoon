...
func TestRealIncusSourceDeletionE2E(t *testing.T) {
	...
	command("config", "device", "add", trustedHostName, "haco-repo-source", "disk", "pool="+pool, "source=haco-repo-source", "path="+gitadapter.RepositoryRoot+"/source", "--project", project)
