...
func (b *RepositoryBackend) ImportWorkspaceVolume(ctx context.Context, object gitrepo.Object, source io.ReadSeeker) error {
	...
	if object.Kind != "work" || object.State != "creating" || object.RestoredFrom != "" || len(object.Members) != 0 || !gitadapter.ValidID(object.Repository) || !core.ValidPersistentResourceRef(core.PersistentResourceRef{ID: "oci:identity", Owner: object.Owner}) || source == nil {
