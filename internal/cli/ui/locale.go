...
var messageCatalogs = [...]map[string]translation{catalog, environmentCatalog, commandCatalog, detailCatalog, operationCatalog, setupCatalog, networkCatalog, configurationCatalog, dailyCatalog}
