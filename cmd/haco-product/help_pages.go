...
var helpPages = []helpPage{
	...
	{Path: "cache", Syntax: "<settings|configure|status|collect|history|clear>", Message: "cache.help", Example: "haco cache status work"},
	...
	{Path: "env forward", Syntax: "--target-port <port> [--protocol tcp|udp] [--port <local-port>] [--json] <name>", Message: "command.env.forward", Example: "haco env forward --target-port 8080 dev"},
	...
	{Path: "git approve", Syntax: "[--save env|all|ask-env|ask-all] [--json] <id>", Message: "command.git.approve", Example: "haco git approve <id>"},
	{Path: "git deny", Syntax: "[--save env|all|ask-env|ask-all] [--json] <id>", Message: "command.git.deny", Example: "haco git deny <id>"},
	...
	{Path: "plugin oci store inspect", Syntax: "[--json] <store>", Message: "command.plugin.oci.store.inspect", Example: "haco plugin oci store inspect <store>"},
	{Path: "plugin oci store create", Syntax: "[--json] <store> [--from <store>]", Message: "command.plugin.oci.store.create", Example: "haco plugin oci store create work"},
	...
	{Path: "network tcp", Syntax: "[--json] --target <name> [--port <port>] [--kind external|host|environment] [--listen 127.0.0.1:0] [--duration 5m]", Message: "command.network.tcp", Example: "haco network tcp --target example.com --port 443"},
	{Path: "network udp", Syntax: "[--json] --target <name> [--port <port>] [--kind external|host|environment] [--listen 127.0.0.1:0] [--duration 5m]", Message: "command.network.udp", Example: "haco network udp --target <host> --port 53"},
	{Path: "network list", Syntax: "[--json]", Message: "command.network.list", Example: "haco network list"},
	...
	{Path: "network host list", Syntax: "[--json]", Message: "command.network.host.list", Example: "haco network host list"},
	{Path: "network host add", Syntax: "[--json] --address <IP> --port <port> [--protocol tcp|udp] <name>", Message: "command.network.host.add", Example: "haco network host add --address 192.0.2.1 --port 8080 service"},
	{Path: "network host remove", Syntax: "<name>", Message: "command.network.host.remove", Example: "haco network host remove service"},
	{Path: "network rule", Syntax: "[--json] --env <name> --target <name> --decision allow|ask|deny [--port <port>] [--kind external|host|environment] [--protocol tcp|udp] [--duration 5m] [--ttl 1h] [--scope instance|environment|global]", Message: "command.network.rule", Example: "haco network rule --env dev --target example.com --port 443 --decision ask"},
