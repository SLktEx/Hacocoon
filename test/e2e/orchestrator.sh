    ...
    case "${1:-}" in
      ...
      get)
        ...
        case "${3:-}" in
          ...
          security.acls) printf '%s\n' 'haco-sandbox-egress' ;;
          security.acls.default.ingress.action|security.acls.default.egress.action) printf '%s\n' 'reject' ;;
          security.acls.default.ingress.logged|security.acls.default.egress.logged) printf '%s\n' 'true' ;;
          *) exit 2 ;;
        esac
        exit 0
        ;;
