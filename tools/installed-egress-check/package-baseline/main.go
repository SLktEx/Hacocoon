// package-baseline is a CI acceptance client for the product-owned package
// repository egress baseline. It uses the installed controller as the ordinary
// Physical Host user and never edits administrator Policy.
package main
