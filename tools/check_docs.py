...
stale_claims = [
    ...
    (r"current milestone position is \*\*v0\.21\*\*", "stale current milestone ceiling"),
    (r"現在のmilestone位置は \*\*v0\.21\*\*", "stale Japanese current milestone ceiling"),
...
require_text("docs/status/versioning-and-release-status.md", [
    ...
    "current milestone position is **v0.25**", "Local Registry infrastructure is deferred and unversioned",
    "cloud implementation is currently deferred",
])
require_text("docs/IMPLEMENTATION_STATUS.md", [
    "current code reality", "current milestone position is **v0.25**", "pkg/clientadapter", "haco ssh",
    ...
    "v0.24 implemented", "v0.25 implemented", "haco-notify", "haco-storage-helper",
    "HACO_PLUGIN_OCI=nerdctl|docker", "design/btrfs-storage-layout.md", "compress=zstd:3",
    "cloud implementation is currently deferred",
])
require_text("docs/status/architecture-and-roadmap.md", [
    ...
    "v0.25 | Managed Btrfs Host Privilege Broker", "current milestone position is **v0.25**",
...
require_text("docs/README.md", [
    ...
    "EGRESS_AUTHORIZATION.md", "INTERACTION_EVENTS.md", "reference/logging.md", "design/btrfs-storage-layout.md",
    "current milestone position is **v0.25**", "v0.25 | Managed Btrfs Host Privilege Broker",
...
require_text("README.md", ["pre-1.0", "haco base list", "haco plugin oci", "pkg/clientadapter", "haco-notify", "v0.25"])
require_text("README.ja.md", ["読み方: はこーん", "pre-1.0", "haco base list", "haco plugin oci", "pkg/clientadapter", "haco-notify", "v0.25"])
