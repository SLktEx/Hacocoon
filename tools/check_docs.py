...
checks = [
    ...
    (r"\|\s*v0\.13\s*\|\s*Local OCI Registry\s*\|", "stale v0.13 Local Registry assignment"),
...
required = [
    ...
    "docs/18_v0.18_LOCAL_OCI_REGISTRY.md", "docs/18_v0.18_LOCAL_OCI_REGISTRY.ja.md",
    "docs/19_v0.19_OCI_SEED_AND_COW.md", "docs/19_v0.19_OCI_SEED_AND_COW.ja.md",
]
for rel in required:
...
require_text("docs/IMPLEMENTATION_STATUS.md", [
    ...
    "v0.18", "v0.19", "cloud implementation is currently deferred",
    "HACO_PLUGIN_OCI=nerdctl|docker",
])
require_text("docs/00_REBASELINE_AND_ROADMAP.md", [
    ...
    "v0.17 | Docker Compatibility Plugin", "v0.18 | Optional Local OCI Registry",
    "v0.19 | OCI Seed Builder & Btrfs/COW",
...
require_text("docs/README.md", [
    ...
    "17_v0.17_DOCKER_COMPATIBILITY_PLUGIN.md", "18_v0.18_LOCAL_OCI_REGISTRY.md",
    "19_v0.19_OCI_SEED_AND_COW.md", "haco base list", "haco plugin oci",
...
require_text("docs/15_v0.15_OCI_SEED_RECOMMENDATION.md", ["OCI Seed Recommendation", "haco plugin oci seed recommend", "top **10%**", "auto_promote"])
require_text("docs/16_v0.16_OCI_IMAGE_DELETION.md", ["OCI Image Deletion", "haco plugin oci image delete", "tombstone"])
require_text("docs/17_v0.17_DOCKER_COMPATIBILITY_PLUGIN.md", ["Docker Compatibility Plugin", "on-demand", "not yet a complete"])
require_text("docs/18_v0.18_LOCAL_OCI_REGISTRY.md", ["Optional Local OCI Registry", "planned", "not required"])
require_text("docs/19_v0.19_OCI_SEED_AND_COW.md", ["OCI Seed Builder", "planned", "Offline Seed Builder", "/var/lib/containerd", "Btrfs/COW"])
