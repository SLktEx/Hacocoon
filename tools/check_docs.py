...
checks = [
    ...
    (r"contiguous through \*\*v0\.17\*\*", "stale contiguous milestone claim"),
...
require_text("docs/README.md", [
    "Source-of-truth order", "Numbering rule", "Design principles",
    ...
    "haco plugin oci docker prepare", "contiguous through **v0.16**",
])
