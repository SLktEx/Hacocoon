...
setup() {
  ...
  # Production packages create /run/hacocoon for the controller. The CI test
  # intentionally runs the controller pieces as the ordinary runner user, so
  # prepare only the narrow per-Environment workload socket directory here.
