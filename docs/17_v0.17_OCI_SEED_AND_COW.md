...
- v0.18 completes Docker compatibility on top of the Environment/Base provisioning foundation established here; existing Docker adapter/systemd code is early v0.18 foundation work.
