...
Status: accepted. Installed saved-ask GitHub acceptance passed at eb16300; see [the exact scope](../status/acceptance-evidence.md#development). Other saved choices have repository integration coverage.
