...
[ADR 0084](0084-ephemeral-run-creation-ownership.md). The provider router forwards
...
checks do not establish Windows terminal acceptance, VPN or other non-default network behavior or
