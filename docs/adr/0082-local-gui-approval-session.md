# ADR 0082: Private local GUI approval sessions
...
The Windows notification client now reuses this session; see [ADR 0083](0083-notification-contained-approval.md). Fresh human acceptance remains separate.
