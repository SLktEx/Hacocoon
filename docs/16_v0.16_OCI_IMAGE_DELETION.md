...
Status: **first deletion slice implemented on `main`; physical immutable-Seed rebuild/GC remains v0.19.**

v0.16 adds explicit OCI image deletion semantics for the trusted Host Seed cache and, when requested, currently managed Environments.
...
5. leaves physical immutable-Seed replacement and old-Seed GC to v0.19.
