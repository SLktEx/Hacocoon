...
Status: **first deletion slice implemented on `main`; physical immutable-Seed rebuild/GC remains v0.18.**
...
5. leaves physical immutable-Seed replacement and old-Seed GC to v0.18.
