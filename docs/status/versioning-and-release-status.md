...
| v0.70 | Environment-owned Disposable Data | partial — canonical disposable-data ownership; native placement/collection remain incomplete |
| v0.71 | Incus Cache Placement | partial — rootfs placement and bound resume; repository paths, Host selection and collection remain incomplete |
| v0.72 | Managed Repository Cache Placement | partial — managed-repository placement implemented; native acceptance, Host selection and collection remain incomplete |

The current milestone position is **v0.72**. This declaration and the table mirror YAML.
