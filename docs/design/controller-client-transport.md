...
The installer invokes `haco setup` through the existing controller. The legacy CLI and its private orchestration were removed in [ADR 0106](../adr/0106-responsibility-layout-and-cli-retirement.md).
