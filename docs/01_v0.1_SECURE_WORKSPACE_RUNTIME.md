...
Historical code for these areas may remain in the repository while being isolated or deferred; it must not become a v0.1 dependency.
...
Once this acceptance gate passes, tag v0.1 alpha. Do not delay v0.1 for v0.2 abstractions or later capabilities.
