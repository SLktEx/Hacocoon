...
- **Next concrete dependency:** replace storage-dependent bootstrap with explicitly owned trusted-host networking and scoped firewall coexistence, preserving Environment deny/proxy policy.
