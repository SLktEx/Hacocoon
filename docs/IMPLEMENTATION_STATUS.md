...
**Next concrete item:** rerun the existing Windows installed-controller packet check for this correction. Its exact Policy allow, verified proxy HTTPS, unapproved-hostname 403, direct TCP refusal and controller cleanup remain unchanged. Acceptance stays pending until that candidate's run succeeds.
