...
- **Observed Windows boundary (2026-09-06):** `c522fc7` completed and verified the image cache, then WSL creation failed after UAC, before a Hacocoon distro or Incus existed. Creation failures now report their numeric exit code. This is not fresh-install acceptance.
