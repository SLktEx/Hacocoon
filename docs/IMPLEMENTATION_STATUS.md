...
| [Notifications / client APIs](reference/interaction-events.md) | implemented | Minimized events and optional adapters; VS Code review and explicit answers use a local GUI through the existing management API. Windows review has scoped acceptance; fresh GUI/human toast and Linux activation gaps remain. |
