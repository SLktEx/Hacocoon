...
**Next concrete item:** add the smallest maintained CI check for installed Environment allowed-proxy/denied-direct traffic using existing controller operations, without a second controller or installer repair fixtures.
